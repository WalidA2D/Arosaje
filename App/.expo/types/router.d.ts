...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)\Login\connexion` | `/(tabs)\Login\inscription` | `/_sitemap` | `/actu` | `/calendrier` | `/explore` | `/loginform` | `/message` | `/options` | `/optnav/botaniste` | `/optnav/donnees` | `/optnav/infoleg` | `/optnav/infoperso` | `/optnav/notif` | `/optnav/question` | `/optnav/secucompte` | `/profil` | `/publier` | `/pubnav/pubdate` | `/pubnav/pubdesc` | `/pubnav/pubentretien` | `/pubnav/pubespece` | `/pubnav/publoca` | `/pubnav/pubphoto` | `/pubnav/pubtitre`;
