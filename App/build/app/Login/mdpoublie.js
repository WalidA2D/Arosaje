...
export default function Support({ setIsModalVisible }) {
    ...
    return (<View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="A" value={"support@arosaje.com"} editable={false}/>
      <Text style={styles.text}>Votre email :</Text>
      <TextInput style={styles.input} placeholder="Votre email" value={email} onChangeText={setEmail}/>
      <Text style={styles.text}>Sujet :</Text>
        <RNPickerSelect placeholder={{ label: "Sélectionnez une option", value: null }} value={subject} onValueChange={(value) => setSubject(value !== null && value !== void 0 ? value : "")} items={[
      ...
      <TextInput style={styles.inputdesc} placeholder="Description" value={description} onChangeText={setDescription}/>
