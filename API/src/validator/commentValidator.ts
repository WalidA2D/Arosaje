...
class CommentValidator {
  checkCreate() {
    return [
      ...
      body("publishedAt")
        ...
        .withMessage(
          "La date de publication doit être au format YYYY-MM-DD HH:mm:ss"
        ),
      body("idPost").isInt().withMessage("L'IdPost doit etre un entier"),
    ];
  }
  checkRead() {
    return [
  ...
  checkReadByPost() {
    return [
      param("id")
        .notEmpty()
        .withMessage("Id du post doit être fourni")
        .isInt()
